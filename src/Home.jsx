    ...
    <>
      <main className="bg-slate-950 h-screen text-white font-serif flex flex-col justify-center items-center p-4">
        <div className="text-center">
          ...
          {/* Options */}
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 mt-6 sm:mt-10 text-gray-500">
            <Link
              to="/dashboard"
              className="px-6 py-3 sm:px-10 sm:py-4 bg-white rounded hover:text-black hover:shadow-lg hover:shadow-cyan-500/50"
            >
              Dashboard
            </Link>
            <Link
